  ...
  return (
    ...
    >
      ...
      {playableFrames.length > 0 ? (
        <div
          className={cn(
            "absolute right-4 bottom-4 flex items-center gap-1.5 rounded-md border border-border/30",
        ...
        >
          ...
          <span className="text-[11px] font-semibold text-foreground/75 tabular-nums">
            {currentDisplay}
          </span>
