...
type IconProps = Omit<ComponentPropsWithoutRef<"svg">, "width" | "height"> & {
  size?: number;
};
...
export function CanvasIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AIIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EditorIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
